...
export default function ChangelogCard({ changelog, onToast }) {
  return (
    <article className="group relative rounded-2xl border border-slate-200/80 bg-white p-6 sm:p-7 shadow-soft hover:shadow-cardHover transition-all duration-200">
